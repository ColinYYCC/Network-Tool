...
function overwriteProxyGroups(params) {
    ...
    params["proxy-groups"] = [
        { name: "🛰️ 自动選擇", type: "url-test", proxies: getMatch(filterAL), url: "http://www.v2ex.com/generate_204", interval: 300, icon: "https://raw.githubusercontent.com/lige47/QuanX-icon-rule/main/icon/quanqiu(3).png" },
        { name: "🔯 故障转移", type: "fallback", proxies: getMatch(filterAL), url: "http://www.v2ex.com/generate_204", interval: 300, icon: "https://raw.githubusercontent.com/fmz200/wool_scripts/main/icons/apps/select.png" },
        { name: "🔮 负载均衡", type: "load-balance", proxies: getMatch(filterAL), strategy: "consistent-hashing", url: "http://www.v2ex.com/generate_204", interval: 300, icon: "https://github.com/shindgewongxj/WHATSINStash/raw/main/icon/loadbalance.png" },
        ...
        // 自動選擇組 (Hidden)
        { name: "香港节点", type: "url-test", proxies: getMatch(filterHK), url: "http://www.v2ex.com/generate_204", interval: 300, hidden: true, icon: "https://raw.githubusercontent.com/Semporia/Hand-Painted-icon/master/Rounded_Rectangle/Hong_Kong.png" },
        { name: "日本节点", type: "url-test", proxies: getMatch(filterJP), url: "http://www.v2ex.com/generate_204", interval: 300, hidden: true, icon: "https://raw.githubusercontent.com/Semporia/Hand-Painted-icon/master/Rounded_Rectangle/Japan.png" },
        { name: "韩国节点", type: "url-test", proxies: getMatch(filterKR), url: "http://www.v2ex.com/generate_204", interval: 300, hidden: true, icon: "https://raw.githubusercontent.com/Semporia/Hand-Painted-icon/master/Rounded_Rectangle/South_Korea.png" },
        { name: "狮城节点", type: "url-test", proxies: getMatch(filterSG), url: "http://www.v2ex.com/generate_204", interval: 300, hidden: true, icon: "https://raw.githubusercontent.com/Semporia/Hand-Painted-icon/master/Rounded_Rectangle/Singapore.png" },
        { name: "美国节点", type: "url-test", proxies: getMatch(filterUS), url: "http://www.v2ex.com/generate_204", interval: 300, hidden: true, icon: "https://raw.githubusercontent.com/Semporia/Hand-Painted-icon/master/Rounded_Rectangle/United_States.png" },
        { name: "英国节点", type: "url-test", proxies: getMatch(filterUK), url: "http://www.v2ex.com/generate_204", interval: 300, hidden: true, icon: "https://raw.githubusercontent.com/Semporia/Hand-Painted-icon/master/Rounded_Rectangle/United_Kingdom.png" },
        { name: "法国节点", type: "url-test", proxies: getMatch(filterFR), url: "http://www.v2ex.com/generate_204", interval: 300, hidden: true, icon: "https://raw.githubusercontent.com/Semporia/Hand-Painted-icon/master/Rounded_Rectangle/France.png" },
        { name: "德国节点", type: "url-test", proxies: getMatch(filterDE), url: "http://www.v2ex.com/generate_204", interval: 300, hidden: true, icon: "https://raw.githubusercontent.com/Semporia/Hand-Painted-icon/master/Rounded_Rectangle/Germany.png" },
        { name: "台湾节点", type: "url-test", proxies: getMatch(filterTW), url: "http://www.v2ex.com/generate_204", interval: 300, hidden: true, icon: "https://raw.githubusercontent.com/Semporia/Hand-Painted-icon/master/Rounded_Rectangle/Taiwan.png" }
    ];
}
...
function overwriteRuleProviders(params) {
    ...
    params["rule-providers"] = {
        ...
        "常见静态CDN非IP": { ...common, behavior: "domain", format: "text", url: "https://ruleset.skk.moe/Clash/non_ip/cdn.txt", path: "./Rules/sukkaw_ruleset/cdn_non_ip.txt" },
        ...
        "流媒体非IP": { ...common, behavior: "classical", format: "text", url: "https://ruleset.skk.moe/Clash/non_ip/stream.txt", path: "./Rules/sukkaw_ruleset/stream_non_ip.txt" },
        ...
        "人工智能非IP": { ...common, behavior: "classical", format: "text", url: "https://ruleset.skk.moe/Clash/non_ip/ai.txt", path: "./Rules/sukkaw_ruleset/ai_non_ip.txt" },
        ...
        "苹果服务非IP": { ...common, behavior: "classical", format: "text", url: "https://ruleset.skk.moe/Clash/non_ip/apple_services.txt", path: "./Rules/sukkaw_ruleset/apple_services.txt" },
        "苹果中国非IP": { ...common, behavior: "classical", format: "text", url: "https://ruleset.skk.moe/Clash/non_ip/apple_cn.txt", path: "./Rules/sukkaw_ruleset/apple_cn_non_ip.txt" },
        "微软CDN非IP": { ...common, behavior: "classical", format: "text", url: "https://ruleset.skk.moe/Clash/non_ip/microsoft_cdn.txt", path: "./Rules/sukkaw_ruleset/microsoft_cdn_non_ip.txt" },
        "微软服务非IP": { ...common, behavior: "classical", format: "text", url: "https://ruleset.skk.moe/Clash/non_ip/microsoft.txt", path: "./Rules/sukkaw_ruleset/microsoft_non_ip.txt" },
        ...
        "下载非IP": { ...common, behavior: "domain", format: "text", url: "https://ruleset.skk.moe/Clash/non_ip/download.txt", path: "./Rules/sukkaw_ruleset/download_non_ip.txt" },
        "内网非IP": { ...common, behavior: "classical", format: "text", url: "https://ruleset.skk.moe/Clash/non_ip/lan.txt", path: "./Rules/sukkaw_ruleset/lan_non_ip.txt" },
        ...
        "国内域名非IP": { ...common, behavior: "classical", format: "text", url: "https://ruleset.skk.moe/Clash/non_ip/domestic.txt", path: "./Rules/sukkaw_ruleset/domestic_non_ip.txt" },
        ...
        "直连非IP": { ...common, behavior: "classical", format: "text", url: "https://ruleset.skk.moe/Clash/non_ip/direct.txt", path: "./Rules/sukkaw_ruleset/direct_non_ip.txt" },
        "全球非IP": { ...common, behavior: "classical", format: "text", url: "https://ruleset.skk.moe/Clash/non_ip/global.txt", path: "./Rules/sukkaw_ruleset/global_non_ip.txt" },
