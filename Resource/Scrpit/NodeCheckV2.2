...
function getaliid(e){let t="al";return FNV1a(`${t}-${e}`)};
function getspcn(e){let t="sc";return FNV1a(`${t}-${e}`)};
...
function getid(e){let t="ld";return FNV1a(`${t}-${e.server}-${e.port}`)};
function getinid(e){let t="ia";return FNV1a(`${t}-${e}`)};
